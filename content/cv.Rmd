...
<a class="ui blue big right corner label">
...
rbind(
  c("building", "Univeristät Konstanz, Germany"),
  c("phone", "+49 irgendwas"),
  c("envelope outline", "<a href = 'mailto:s.roth@uni-konstanz.de'>s.roth@uni-konstanz.de</a>"),
  c("globe", 'Blog <i class ="right chevron icon"></i> <a href = "www.systats.eu" target="_blank">systats.eu</a>'),
  c("github", 'Github <i class="right chevron icon"></i> <a href = "www.github.com/systats" target="_blank">systats</a>')
) %>%
  as_tibble %>% 
...
rbind(
  ...
  c("since 2017", "Data Scientist at <a href = 'www.paraboost.de'>Paraboost </a>GmBH."),
