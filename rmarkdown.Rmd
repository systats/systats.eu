...
`html_documents` allows the code chunks to be hidden by default, but visible with a click. This is easily done by adding `code_folding: hide` to your YAML header (code ident matters!).
...
R Markdown file
You can insert separate R Markdown files too; text and code will be incorporated seamlessly into this page. This R Markdown file is considered the ‘parent’ file, and the one that is incorporated is the ‘child’ file. In the code chunk below, we’ll say 
...
* [rmdshower github](https://github.com/shower/shower) provides a wrapper around the shower presentation engine
* [rmdshower live](https://github.com/MangoTheCat/rmdshower)
